...
public class Trash2Pursue : StateMachineBehaviour
{
    ...
    public Trash2Combat checkAttack;

    private bool stopAttacking = false;

    // The attack range of the Trash2.
    ...
    {
        // Once we enter the pursue state get the transforms of the Trash2 and the Player.
        Trash2 = animator.GetComponent<Transform>();
        player = GameObject.FindGameObjectWithTag("Player").transform;
        checkAttack = GameObject.Find("Trash2").GetComponent<Trash2Combat>();
    }
